<div class="container">
    ...
    <form onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions and Privacy Policy'); return false; }" action="<?php echo base_url(); ?>tmt_online/save_passenger" method="POST" class="form-horizontal" data-toggle="validator" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="meta[id_number]" value="<?php echo set_value('meta[id_number]'); ?>" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-3 control-label">ID Card Upload</label>
            <div class="col-sm-9">
