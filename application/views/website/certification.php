        ...
        <div class="tz-l">
            <div class="tz-l-2 left_menu" >
                <ul>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>user/certification" class="tz-lma">Certification</a>
                    </li>
                    <li>
            ...
            <div class="tz-2-com tz-2-main">
                ...
                <div class="db-list-com tz-db-table">
                    ...
                    <div class="hom-cre-acc-left hom-cre-acc-right">
                            ...
                            <div class="">
                                <form>
                                    <div class="form-horizontal">
                                        ...
                                        <h5><?php echo $certification->institute; ?></h5>
                                        <h5><?php echo $certification->period; ?></h5>
                                        <p><?php echo $certification->location; ?></p>
                                        <a style="float:right" class="btn btn-danger" onclick="return check_delete();" href="<?php echo base_url(); ?>user/delete_certification/<?php echo $certification->pk_certification_id; ?>"><i class="fa fa-trash"></i>&nbsp;Delete this Information</a><br />
                                    </div>
                                </form>
                            </div>
                            <?php
                        ...
                        <br />
                        <div class="">
                            <form name="user" action="<?php echo base_url(); ?>user/save_certification_info" method="POST">
                                <div class="form-horizontal">
                                    <div class="row">
                                        <div class="control-group col s12 m12">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input name="name" required id="name" type="text" class="validate" placeholder="Certification Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="control-group col s12 m12">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input name="institute" required id="institute" type="text" class="validate" placeholder="Institution Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="control-group col s12 m12">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input name="period" required id="period" type="text" class="validate" placeholder="Time Period">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="control-group col s12 m12">
                                            <label class="control-label">Institute Location</label>
                                            <div class="controls">
                                                <?php echo form_error('location'); ?>
                                                <input name="location" required id="location" type="text" class="validate" placeholder="Institute Location">
                                            </div>
                                        </div>
                                    </div>
                                </div>
