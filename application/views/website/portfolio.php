            ...
            <div class="tz-2-com tz-2-main">
                ...
                <div class="col-md-12">
                    ...
                    foreach ($portfolios as $portfolio) {
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="hom-pro">
                                <h5><?php echo $portfolio->name; ?></h5><br />
                                <p><?php echo $portfolio->description; ?></p>   <p><a style="margin-right:10px" href="<?php echo $portfolio->link; ?>">Explore Now</a> 
                               <a onclick="return check_delete();" href="<?php echo base_url(); ?>user/delete_portfolio/<?php echo $portfolio->pk_portfolio_id; ?>" style="background-color:#ff0a0a;box-shadow: 0 0 0 2.25pt #ff0a0a;">Delete</a> </p> 
                            </div><br />
                        </div>
                        <?php
                    }
                ...
                <div class="db-list-com tz-db-table">
                    <div class="hom-cre-acc-left hom-cre-acc-right">
                        <div class="">
                            <form name="user" action="<?php echo base_url(); ?>user/save_portfolio" method="POST">
                                ...
                                <div class="form-horizontal">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name_1" required placeholder="Project Name" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">Project Link</label>
                                        <div class="controls">
                                            <input type="text" name="link_1" placeholder="http://www.website.com" />
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea type="text" name="description_1" required placeholder="Project Description" ></textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr/>
                                ...
                                <div class="row">
                                    <div class="input-field col s12 v2-mar-top-40"> <button type="submit" class="waves-effect waves-light btn-large full-btn">Save Portfolio</button> </div>
                                </div>
                            </form>
                        </div>
                    </div>
